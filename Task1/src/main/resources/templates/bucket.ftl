...
<head>
    ...
    <script type="text/javascript" src="/js/delete.product.js"></script>
        ...
        <div id="templatemo_main">
            ...
            <#if model.hasBuckets == true>
                <table>
                    ...
                    <#list model.user.bucketList as bucket>
                        <tr>
                            <td><img src="${bucket.car.urlImageCar}" width="50px" height="50px"><a
                                    href="/car?id=${bucket.car.id}"><#--${bucket.car.name}--></a></td>
                            <td>${bucket.car.price}</td>
                            <td>${bucket.count}</td>
                            <td>
                                <form action="/delete_bucket?id=${bucket.id}" id="form_delete${bucket.id}" name="delete" method="post">
                                    <a href="#" onClick="document.getElementById('form_delete${bucket.id}').submit();">
                                        <br />Удалить</a>
                                </form>
                            </td>
                        </tr>
